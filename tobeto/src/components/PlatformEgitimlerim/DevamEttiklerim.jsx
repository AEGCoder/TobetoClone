...
const DevamEttiklerim = ({egitimlerData}) => {
  return (
    <div>
                <h2 className="pt-10 pb-5 sm:text-2xl text-lg sm:pl-0 pl-5 font-medium tracking-wider">Devam Eden Eğitimleri Görüyorsunuz</h2>
...
export default DevamEttiklerim